/**
 * Color Configuration for Shared Library
 * 
...
const RAW_PRIMARY_COLOR = '#f0940a'; // Default orange color
...
export const PRIMARY_TONES = {
  ...
  light: lightenColor(PRIMARY_COLOR, 30),      // Light orange
  lighter: lightenColor(PRIMARY_COLOR, 50),    // Very light orange
  lightest: lightenColor(PRIMARY_COLOR, 70),   // Lightest orange
  
  // Dark tones (darker variations of primary)
  dark: darkenColor(PRIMARY_COLOR, 20),        // Dark orange
  darker: darkenColor(PRIMARY_COLOR, 40),     // Darker orange
  darkest: darkenColor(PRIMARY_COLOR, 60),     // Darkest orange
  
  // Saturated variations
  saturated: adjustSaturation(PRIMARY_COLOR, 20),     // More saturated orange
  desaturated: adjustSaturation(PRIMARY_COLOR, -30),  // Less saturated orange
  
  // Warm/cool variations
  warm: adjustHue(PRIMARY_COLOR, 10),         // Slightly warmer orange
  cool: adjustHue(PRIMARY_COLOR, -10),        // Slightly cooler orange
  
  // Neutral variations
  neutral: adjustSaturation(PRIMARY_COLOR, -50),     // Very desaturated orange
  muted: adjustSaturation(PRIMARY_COLOR, -40),       // Muted orange
} as const;
