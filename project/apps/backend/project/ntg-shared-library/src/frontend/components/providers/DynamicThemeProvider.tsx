...
import { useDynamicTheme, DynamicThemeConfig } from '../../hooks/useDynamicTheme';
 ...
 */
export function DynamicThemeProvider({ children, config }: DynamicThemeProviderProps) {
  const {
    primary,
    primaryLight,
    primaryLighter,
